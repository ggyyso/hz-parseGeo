...
public class SQLHelper {
    ...
    public static Connection establishConnection(File file, Properties prop) throws Exception {
        Connection c;
        try {
            //Class.forName("org.sqlite.JDBC");
            c =
                    DriverManager.getConnection("jdbc:sqlite:" + file.getAbsolutePath(),prop);
        } catch ( SQLException e) {
            throw new Exception("Establish Connection failed.", e);
        }
        return c;
    }
    public static void createTable(Connection connection, String tableName, String schema, String... onSuccess) throws Exception {
